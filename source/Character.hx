...
class Character extends FlxSprite
{
	...
	public var screwedColor:flixel.util.FlxColor;
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		if(curCharacter.contains('gf')){
			screwedColor = flixel.util.FlxColor.fromString('0xffA5004D');
		}
		else if(curCharacter.contains('bf')){
			screwedColor = flixel.util.FlxColor.fromString('0xff31B0D1');
		}
		else if (curCharacter == 'screwedfriend'){
			screwedColor = flixel.util.FlxColor.fromString('0xff00FFB3');
		}
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				case 'screwedfriend':
					var tex = Paths.getSparrowAtlas('poopbrimmer');
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
